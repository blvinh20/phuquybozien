                ...
                <table className="w-full min-w-[640px] table-fixed border-collapse">
                  ...
                  <thead>
                    <tr className="bg-surface-container-high/50">
                      ...
                      <th className="px-5 py-3 text-[10px] font-black text-secondary uppercase tracking-widest text-right align-middle">Chênh lệch ròng</th>
                    </tr>
                  </thead>
                      ...
                      <tr key={m.id} className="hover:bg-surface-container-low transition-colors align-middle">
                        ...
                        <td className="px-5 py-4 text-right align-middle">
                          ...
                          <span className={cn(
                            ...
                            {displayBalance >= 0 ? <TrendingUp size={14} /> : <TrendingDown size={14} />}
                          </span>
                            );
                          })()}
                        </td>
...
function TreasurerCashflowCard({
  ...
  return (
    <div className="rounded-[1.5rem] border border-outline-variant/10 bg-surface-container p-4 mb-4">
